...
public class ActRuTimerJob implements Serializable {
     ...
     *  字段名称：
     * 
     * 数据库字段信息：LOCK_EXP_TIME_ TIMESTAMP(19)
     */
    ...
    public String toString() {
        ...
        sb.append(", LOCK_EXP_TIME_=").append(LOCK_EXP_TIME_);
        ...
        sb.append(", RETRIES_=").append(RETRIES_);
