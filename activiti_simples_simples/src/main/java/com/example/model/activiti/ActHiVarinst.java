...
public class ActHiVarinst implements Serializable {
     ...
     *  字段名称：
     * 
     * 数据库字段信息：LAST_UPDATED_TIME_ TIMESTAMP(19)
     */
    ...
    public String toString() {
        ...
        sb.append(", VAR_TYPE_=").append(VAR_TYPE_);
        ...
        sb.append(", LAST_UPDATED_TIME_=").append(LAST_UPDATED_TIME_);
        sb.append("]");
        return sb.toString();
    }
}